---
title: <center>ST-3 Oil Production Data</center>
...
```{r fig.width=12, fig.height=8,dpi=300, plot_1, cache=FALSE}
oil_sands
```


```{r fig.width=12, fig.height=8,dpi=300, plot_1b, cache=FALSE}
oil_sands_plain
```

### All production

```{r fig.width=12, fig.height=8,,dpi=300, plot_2, cache=FALSE}
all_crude
```
